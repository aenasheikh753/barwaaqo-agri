...
export function ServiceCard({ title, description, icon }: ServiceCardProps) {
    return (
        <div className="group h-full flex flex-col items-start p-10 rounded-2xl bg-white border border-custom-accent/50 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_50px_rgba(0,0,0,0.1)] transition-all duration-500 transform hover:-translate-y-2 relative overflow-hidden">
            ...
            <div className="mt-8 pt-6 border-t border-custom-accent/30 w-full opacity-0 group-hover:opacity-100 transition-opacity duration-500">
