...
export function Button({ variant = "primary", children, className = "", ...props }: ButtonProps) {
    const baseStyles = "inline-flex items-center justify-center px-6 py-3 rounded-xl font-body font-medium transition-all duration-300 ease-in-out cursor-pointer active:scale-95 focus:outline-none focus:ring-2 focus:ring-offset-2";
